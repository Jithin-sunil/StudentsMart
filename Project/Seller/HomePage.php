...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1">
    <tr>
      <th scope="col"><div align="center">WELCOME <?php echo $_SESSION['sname'] ?></div></th>
    </tr>
    <tr>
    ...
    <tr>
     <td><a href="ChangePassword.php">Change Password</a></td></td>
    </tr>
    <tr>
      <td><a href="Product.php">Product</a></td>
    </tr>
    <tr>
      <td><a href="ViewUserBooking.php">View User Booking</a></td>
    </tr>
  </table>
</form>
</body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="ViewUserBooking.php" class="nav-item nav-link">View User Booking</a>

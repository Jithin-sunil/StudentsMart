...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1">
    <tr>
      <td><div align="center">WELCOME <?php echo $_SESSION['uname'] ?></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><a href="ViewProduct.php">View Product</a></td>
    </tr>
    <tr>
      <td><a href="SearchProduct.php">Search Product</a></td>
    </tr>
    <tr>
      <td><a href="MYCart.php">My Cart</a></td>
    </tr>
    <tr>
      <td><a href="MyBooking.php">My Booking</a></td>
    </tr>
    <tr>
      <td><a href="MyComplaints.php">My Complaints</a></td>
    </tr>
  </table>
</form>
</body>

                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="Guest/NewLogin.php" class="nav-item nav-link active">Log In</a> 
                            <a href="Guest/NewUser.php" class="nav-item nav-link">New User</a> 
                            <a href="Guest/NewSeller.php" class="nav-item nav-link">New Seller</a>
